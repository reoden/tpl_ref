 ...
 * $\Leftrightarrow$ left/on line/right. If the optional argument $eps$ is given
 * 0 is returned if $p$ is within distance $eps$ from the line. P is supposed to
 * be Point<T> where T is e.g. double or long long. It uses products in
